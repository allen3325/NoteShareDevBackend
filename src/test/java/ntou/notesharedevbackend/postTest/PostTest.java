...
//        post.setWantEnterUsersEmail(wantEnterUsersEmail);
    ...
    public void testGetQAPost() throws Exception {
        ...
        mockMvc.perform(get("/post/" + post.getId())
                ...
                .andExpect(jsonPath("$.res.answersUserObj").isEmpty());
    }

    @Test
    public void testGetRewardPost() throws Exception {
        Post post = createRewardPost();
        Note note1 = noteRepository.findById(post.getAnswers().get(0)).get();
        AppUser appUser1 = userRepository.findByEmail(note1.getHeaderEmail());
        Note note2 = noteRepository.findById(post.getAnswers().get(1)).get();
        AppUser appUser2 = userRepository.findByEmail(note2.getHeaderEmail());
        AppUser appUser = userRepository.findByEmail(post.getEmail().get(0));
        mockMvc.perform(get("/post/" + post.getId())
                        .headers(httpHeaders))
                .andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$.res.emailUserObj.[0].userObjName").value(appUser.getName()))
                .andExpect(jsonPath("$.res.emailUserObj.[0].userObjAvatar").value(appUser.getHeadshotPhoto()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].id").value(note1.getId()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].date").hasJsonPath())
...
//                .andExpect(jsonPath("$.res.wantEnterUsersEmail").value(post.getWantEnterUsersEmail()))
                ...
                .andExpect(jsonPath("$.res.answersUserObj.[0].id").value(note.getId()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].date").hasJsonPath())
...
//                .andExpect(jsonPath("$.res.applyUserObj").isEmpty())
    ...
    public void testGetAllQAPost() throws Exception {
        ...
        mockMvc.perform(get("/post/postType/QA")
                ...
                .andExpect(jsonPath("$.res[0].answersUserObj").isEmpty())
                ...
                .andExpect(jsonPath("$.res[1].answersUserObj").isEmpty())
                ...
                .andExpect(jsonPath("$.res[2].answersUserObj").isEmpty())
        ;
...
//        }
    ...
    public void testRewardPostModifyPublishStatusAfterChooseBestAnswer() throws Exception {
        ...
        AppUser appUser1 = userRepository.findByEmail(answerNote.getHeaderEmail());
        ...
        mockMvc.perform(put("/post/publish/" + post.getId())
                ...
                .andExpect(jsonPath("$.res.emailUserObj.[0].userObjName").value(appUser.getName()))
                .andExpect(jsonPath("$.res.emailUserObj.[0].userObjAvatar").value(appUser.getHeadshotPhoto()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].id").value(answerNote.getId()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].date").hasJsonPath())
                .andExpect(jsonPath("$.res.answersUserObj.[0].userObj.userObjEmail").value(appUser1.getEmail()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].userObj.userObjName").value(appUser1.getName()))
                .andExpect(jsonPath("$.res.answersUserObj.[0].userObj.userObjAvatar").value(appUser1.getHeadshotPhoto()))
    ...
    public void testQAPostModifyPublishStatusAfterChooseBestAnswer() throws Exception {
        ...
        AppUser appUser1 = userRepository.findByEmail(comment.getEmail());
        postRepository.save(post);
        AppUser appUser = userRepository.findByEmail(post.getEmail().get(0));
    ...
    public void testRewardPostModifyPublishStatusToPublic() throws Exception {
        ...
        AppUser appUser = userRepository.findByEmail(post.getEmail().get(0));
        Note note = noteRepository.findById(post.getAnswers().get(0)).get();
        AppUser appUser1 = userRepository.findByEmail(note.getHeaderEmail());
        mockMvc.perform(put("/post/publish/" + post.getId())
                        .headers(httpHeaders))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.res.id").value(post.getId()))
...
//                .andExpect(jsonPath("$.res.[0].applyUserObj.[0].userObjAvatar").value(appUser.getHeadshotPhoto()))
                ...
                .andExpect(jsonPath("$.res.[0].answersUserObj.[0].id").value(note.getId()))
                .andExpect(jsonPath("$.res.[0].answersUserObj.[0].date").hasJsonPath())
    ...
    public void testGetHotPost() throws Exception {
        ...
        mockMvc.perform(get("/post/hotPosts/" + offset + "/" + pageSize)
                ...
                .andExpect(jsonPath("$.res.content.[0].email.[0]").value(post.getEmail().get(0)))
                .andExpect(jsonPath("$.res.content.[0].department").value(post.getDepartment()))
                .andExpect(jsonPath("$.res.content.[0].subject").value(post.getSubject()))
                .andExpect(jsonPath("$.res.content.[0].title").value(post.getTitle()))
                .andExpect(jsonPath("$.res.content.[0].professor").value(post.getProfessor()))
                .andExpect(jsonPath("$.res.content.[0].school").value(post.getSchool()))
                .andExpect(jsonPath("$.res.content.[0].content").value(post.getContent()))
                .andExpect(jsonPath("$.res.content.[0].date").hasJsonPath())
                .andExpect(jsonPath("$.res.content.[0].bestPrice").value(post.getBestPrice()))
                .andExpect(jsonPath("$.res.content.[0].referencePrice").value(IsNull.nullValue()))
                .andExpect(jsonPath("$.res.content.[0].referenceNumber").value(IsNull.nullValue()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].id").value(post.getComments().get(0).getId()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].author").value(post.getComments().get(0).getAuthor()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].email").value(post.getComments().get(0).getEmail()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].content").value(post.getComments().get(0).getContent()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].likeCount").value(post.getComments().get(0).getLikeCount()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].liker").isEmpty())
                .andExpect(jsonPath("$.res.content.[0].comments.[0].floor").value(post.getComments().get(0).getFloor()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].date").value(post.getComments().get(0).getDate()))
                .andExpect(jsonPath("$.res.content.[0].comments.[0].picURL").isEmpty())
                .andExpect(jsonPath("$.res.content.[0].comments.[0].best").value(post.getComments().get(0).getBest()))

                .andExpect(jsonPath("$.res.content.[0].comments.[1].id").value(post.getComments().get(1).getId()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].author").value(post.getComments().get(1).getAuthor()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].email").value(post.getComments().get(1).getEmail()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].content").value(post.getComments().get(1).getContent()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].likeCount").value(post.getComments().get(1).getLikeCount()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].liker").isEmpty())
                .andExpect(jsonPath("$.res.content.[0].comments.[1].floor").value(post.getComments().get(1).getFloor()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].date").value(post.getComments().get(1).getDate()))
                .andExpect(jsonPath("$.res.content.[0].comments.[1].picURL").isEmpty())
                .andExpect(jsonPath("$.res.content.[0].comments.[1].best").value(post.getComments().get(1).getBest()))
                .andExpect(jsonPath("$.res.content.[0].commentCount").value(post.getCommentCount()))
                .andExpect(jsonPath("$.res.content.[0].answers").isEmpty())
                .andExpect(jsonPath("$.res.content.[0].vote").isEmpty())
                .andExpect(jsonPath("$.res.content.[0].voteUserObj").isEmpty())

                .andExpect(jsonPath("$.res.content.[0].collabNoteAuthorNumber").value(IsNull.nullValue()))

                .andExpect(jsonPath("$.res.content.[0].collabApplyUserObj").isEmpty())

                .andExpect(jsonPath("$.res.content.[0].collabApply").value(IsNull.nullValue()))

                .andExpect(jsonPath("$.res.content.[0].publishDate").value(post.getPublishDate()))
                .andExpect(jsonPath("$.res.content.[0].authorUserObj.userObjEmail").value(appUser.getEmail()))
                .andExpect(jsonPath("$.res.content.[0].authorUserObj.userObjName").value(appUser.getName()))
                .andExpect(jsonPath("$.res.content.[0].authorUserObj.userObjAvatar").value(appUser.getHeadshotPhoto()))
                .andExpect(jsonPath("$.res.content.[0].emailUserObj.[0].userObjEmail").value(appUser.getEmail()))
                .andExpect(jsonPath("$.res.content.[0].emailUserObj.[0].userObjName").value(appUser.getName()))
                .andExpect(jsonPath("$.res.content.[0].emailUserObj.[0].userObjAvatar").value(appUser.getHeadshotPhoto()))
